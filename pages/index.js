...
const Home = () => {
	return (
		<div className='bg-primary/60 h-full'>
			{/* text */}
			<div className='h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 '>
				<div className='h-full text-center flex flex-col justify-center  xl:pt-40 xl:text-left container mx-auto'>
					...
					<motion.p
						...
						Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem culpa ut eius nihil, saepe quam tempore
						accusantium blanditiis beatae reiciendis.
					</motion.p>
			...
			{/* image */}
			<div className='w-[1200px] max-h-[1850px] h-full absolute right-0 bottom-0'>
				...
				<motion.div
					...
					className='h-full w-full max-w-[737px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[8%] pointer-events-none'>
					<Avatar />
				</motion.div>
			</div>
		</div>
